...
import { Send, CheckCircle, AlertCircle, Building2, DollarSign, Users, Target } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Financial Insights AI</h1>
              <p className="text-sm text-gray-600">Institutional-Grade Analysis for HNWI</p>
            </div>
          </div>
        </div>
      </header>
        ...
        >
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-3xl mx-auto mb-6">
            <p className="text-sm text-blue-900">
              <strong className="text-blue-700">⚠️ Required vs. Optional:</strong><br />
              Fields marked with <span className="text-red-600 font-bold">*</span> are <strong>required for the system to generate your report</strong>.<br />
              Other fields are optional but will <strong>significantly improve the quality and specificity</strong> of your analysis.
            </p>
          </div>
          ...
          {currentStep === 1 && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Contact & Business Information</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Business Valuation *
                    <span className="block text-xs font-normal text-gray-500 mt-1">
                      Required: Generates exit scenarios and valuation benchmarks
                    </span>
                  </label>
                  <input
                    type="number"
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Current estimated business value (USD)</p>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Exit Timeline *
                    <span className="block text-xs font-normal text-gray-500 mt-1">
                      Required: Prioritizes strategies and structures your roadmap
                    </span>
                  </label>
                  <select
                    name="exitTimeline"
          ...
          {currentStep === 2 && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Financial Snapshot</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Total Net Worth *
                    <span className="block text-xs font-normal text-gray-500 mt-1">
                      Required: Calculates concentration risk and diversification strategies
                    </span>
                  </label>
                  <input
                    type="number"
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Total net worth in USD</p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Total annual income from all sources</p>
                </div>
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Annual Tax Burden *
                    <span className="block text-xs font-normal text-gray-500 mt-1">
                      Required: Identifies tax reduction strategies (QSBS, relocation, etc.)
                    </span>
                  </label>
                  <input
                    type="number"
                    ...
                    placeholder="4200000"
                  />
                  <p className="text-xs text-gray-500 mt-1">Total annual tax payments</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {currentStep === 3 && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Your Primary Goal</h3>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <ul className="space-y-2 text-sm text-blue-800">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Your information will be securely submitted to our financial analysis team</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span>Optional: Schedule a follow-up consultation with our financial strategists</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                  <h4 className="font-semibold text-gray-900 mb-3">Privacy & Confidentiality</h4>
                  <p className="text-sm text-gray-700">
                    All information submitted is encrypted and handled with strict confidentiality. 
                    We comply with all financial privacy regulations and will never share your data 
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 border-2 border-green-300 rounded-lg p-8 text-center">
                    ...
                    <h4 className="text-2xl font-bold text-green-900 mb-3">Thank You!</h4>
                    ...
                    <p className="text-sm text-green-600 mt-4">
                      Please check your email at <strong>{formData.email}</strong> for confirmation 
                      and next steps.
                    </p>
                  </div>
                )}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-red-700 mt-1">
                          There was an error submitting your form. Please try again or contact us at terry@wrigitail.com
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="max-w-7xl mx-auto px-6 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Wrigitail. All rights reserved.</p>
          <p className="mt-2 text-gray-400">Institutional-Grade Financial Analysis for HNWI</p>
        </div>
      </footer>
    </div>
  );
